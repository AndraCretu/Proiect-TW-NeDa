...
<div class="container-fluid">
	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
	  ...
	  <h1 style="font-family:verdana; color:blue; font-size: 150%">Information about deaths:<br><br></h1>
  ...
  <br><br>
	 ...
	 <br><br>
	  <div class="row">
		  <div class="col-sm-6">
		     <img class="hidden-xs" src="/resources/img/7.png" alt="Nepal" width="460" height="345">
	  </div>
		  <div class="col-sm-6">
